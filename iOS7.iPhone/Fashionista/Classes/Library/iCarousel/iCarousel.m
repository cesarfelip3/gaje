...
#define DECELERATE_THRESHOLD 0.01f
#define SCROLL_SPEED_THRESHOLD 2.0f
#define SCROLL_DISTANCE_THRESHOLD 0.01f
#define DECELERATION_MULTIPLIER 60.0f
...
{   
    ...
    switch (_type)
    {
        ...
        {
            CGFloat tilt = [self valueForOption:iCarouselOptionTilt withDefault:0.4f];
