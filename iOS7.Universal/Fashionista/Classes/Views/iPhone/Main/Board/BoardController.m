...
- (IBAction)onCameraButtonTouched:(id)sender
{
    ...
    if ([[UIDevice currentDevice] userInterfaceIdiom] == UIUserInterfaceIdiomPad) {
        storyboard = [UIStoryboard storyboardWithName:@"iPad_upload" bundle:nil];
        controller = [storyboard instantiateViewControllerWithIdentifier:@"upload_home"];
    } else {
        storyboard = [UIStoryboard storyboardWithName:@"upload" bundle:nil];
        controller = [storyboard instantiateViewControllerWithIdentifier:@"upload_home"];
    }
