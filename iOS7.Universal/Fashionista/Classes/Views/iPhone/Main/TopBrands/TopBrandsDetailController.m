...
- (void)setup
{
    ...
    CGFloat height = self.photo.height * width / self.photo.width;
    
    self.imageContent.frame = CGRectMake(self.imageContent.frame.origin.x, self.imageContent.frame.origin.y, width, height);
    _imageBkg.frame = CGRectMake(0, _imageBkg.frame.origin.y, width + 35, height + 25);
    self.tableView.tableHeaderView.frame = CGRectMake(0, 0, width + 35, height + 35);
